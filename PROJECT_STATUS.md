...
- **Legacy landing page** (`apps/landing-page`) — Next.js marketing site superseded by the Astro site; no longer deployed.
...
### Prior-intent mining and history context
...
### Fix loop and agent verification environment
