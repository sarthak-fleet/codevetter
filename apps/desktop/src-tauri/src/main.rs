...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::agent_terminal::start_agent_terminal,
            commands::agent_terminal::send_codex_agent_terminal_input,
            commands::agent_terminal::send_agent_terminal_input,
            commands::agent_terminal::stop_codex_agent_terminal,
            commands::agent_terminal::stop_agent_terminal,
            commands::agent_terminal::resize_codex_agent_terminal,
            commands::agent_terminal::resize_agent_terminal,
