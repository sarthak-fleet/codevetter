# warm-local-verification-runtime Specification

## Purpose
Define the private persistent local runtime, CLI outcomes, performance and resource gates, and T-Rex ownership for warm browser verification.
