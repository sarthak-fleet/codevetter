...
Define the immutable targets, complete coverage ledger, bounded execution,
candidate qualification, resume behavior, and machine-readable evidence
required for trustworthy local reviews.
