# deterministic-browser-state Specification

## Purpose
Define isolated authentication, named backend state, pre-navigation determinism, network boundaries, and sensitive-state handling for browser verification.
