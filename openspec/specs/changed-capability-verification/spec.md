# changed-capability-verification Specification

## Purpose
Define how exact Git changes select a minimal safe deterministic scenario set without allowing inferred hints to weaken explicit coverage.
